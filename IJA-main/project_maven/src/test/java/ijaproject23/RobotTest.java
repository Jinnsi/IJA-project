...
public class RobotTest {
	...
	// Helper function
    private Room setup() {
        Room room = Room.create(10, 10, sim);
        // createObstacleAt takes (row,col)
        // Position takes (y,x)
        room.createObstacleAt(3, 5, 0);
        room.createObstacleAt(2, 5, 0);
        room.createObstacleAt(5, 2, 0);
        room.createObstacleAt(4, 6, 0);
